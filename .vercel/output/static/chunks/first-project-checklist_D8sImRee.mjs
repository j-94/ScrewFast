const id = "ja/guides/first-project-checklist.mdx";
						...
						const _internal = {
							type: 'content',
							filePath: "/Users/jobs/Developer/5-WORKING-CACHE/5.A-NOTEBOOKS/5.B.2-JMBFLOORS/web1/ScrewFast-astro/src/content/docs/ja/guides/first-project-checklist.mdx",
							rawData: undefined,
						};
